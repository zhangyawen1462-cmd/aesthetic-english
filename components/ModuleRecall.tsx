...
import { Eye, EyeOff, Check, Quote } from "lucide-react";
...
export default function ModuleRecall({ theme }: any) {
  ...
  const borderColor = theme.text; // 边框同色
  const paperColor = theme.bg;    // 背景同色
        ...
        <div className="relative border-l-2 pl-6" style={{ borderColor: theme.accent }}>
          ...
          <div className="relative min-h-[160px]">
             ...
             <motion.div
                ...
                style={{ 
                  backgroundColor: paperColor, // 与背景同色，制造“遮挡”假象
                  borderColor: borderColor,    // 边框
                  borderStyle: 'dashed'        // 虚线边框增加档案感
                }}
             >
